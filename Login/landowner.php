    ...
    <div class="land-img">
     <img src="../images/5.jpg" class="w-100 h-100">
      ...
      <div>
        ...
        <p class="ma-0"><a href="../Login/postland.php?category=cat1" class="button pa-0">Post Lands</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="column pa-1  mb-0">
    ...
    <div class="land-img">
      ...
      <div >
        ...
        <p class="ma-0"><a href="../Login/postland.php?category=cat2" class="button pa-0">Post Lands</a></p>
      </div>
    </div>
  </div>
  <div class="column pa-1  mb-0">
    ...
    <div class="land-img">
      ...
      <div>
        ...
        <p class="ma-0"><a href="../Login/postland.php?category=cat3" class="button pa-0">Post Lands</a></p>
